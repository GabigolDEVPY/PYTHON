...
while True:
    funct = input('Pressione [1] para codificar ou [2] para decodificar, ou [3] para fechar: ')
    limpar()
    ...
    'x': '01111000', 'y': '01111001', 'z': '01111010', '{': '01111011', '|': '01111100', '}': '01111101', '~': '01111110',
        ...
        limpar()
        print(f'A PALAVRA {palavra} CODIFICADA É:')
        print()
        print(nova_palavra)
        espaco()
